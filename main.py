    ...
    for year in year_list:
        for season in ["summer", "winter"]:
            for time_zone in [1, 2, 3]:
                for paper in [0,1, 2]:  # create algorithm to find how many papers
            ...
            for time_zone in time_zones:
                for paper in range(2, 3):
                    ...
                    if code in codes:
                        ...
                        past_paper.multi_choice_ans_finder(1)
...
if __name__ == '__main__':
    ...
    #scrape_pdf_paper(category="Cambridge%20IGCSE", subject_code="0620", years=[2020], mark_scheme=True)
